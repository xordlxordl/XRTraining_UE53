...
RtFBXLoader* RtFBXLoader::mInstance;

void RtFBXLoader::InitSubSystem(UGameInstance* pInstance)
{
	//mInstance = pInstance->GetSubsystem<RtFBXLoader>();
}
...
void RtFBXLoader::InitializeSdkObjects()
{
}

void RtFBXLoader::DestroySdkObjects()
{
	if (mpScene) {
...
bool RtFBXLoader::LoadScene(const char* pFilename)
{
...
bool RtFBXLoader::SetCurrentAnimStack(int pIndex)
{
...
void RtFBXLoader::Tick(float DeltaTime)
{
...
void RtFBXLoader::LoadSubMesh(FbxNode* pNode, FbxTime& pTime, FbxAnimLayer* pAnimLayer, FbxAMatrix& pGlobalPosition, FbxPose* pPose,
...
void RtFBXLoader::LoadMesh(FbxNode* pNode, FbxTime& pTime, FbxAnimLayer* pAnimLayer, FbxAMatrix& pGlobalPosition, FbxPose* pPose,
...
void RtFBXLoader::LoadNode(FbxNode* pNode, FbxTime& pTime, FbxAnimLayer* pAnimLayer, FbxAMatrix& pParentGlobalPosition, FbxAMatrix& pGlobalPosition, FbxPose* pPose,
...
void RtFBXLoader::LoadNodeRecursive(FbxNode* pNode, FbxTime& pTime, FbxAnimLayer* pAnimLayer, FbxAMatrix& pParentGlobalPosition, FbxPose* pPose,
	RtFbxProcedualMeshInfo* pFbxMeshInfo)
{
...
TSharedPtr<RtFbxProcedualMeshInfo> RtFBXLoader::LoadFbx(const FString& fbxFilePath)
{
