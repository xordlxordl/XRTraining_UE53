...
#include "Rt_Place_Trainee_Assign_List.generated.h"

class URt_Place_Trainee;
class URt_Place_Trainee_Assign_Popup;
class URt_ListViewObject_TraineeInfo;
/**
 * 
 */
UCLASS()
class RTGAME_API URt_Place_Trainee_Assign_List : public URt_UserWidget
{
	GENERATED_BODY()
...
public:
	...
	TWeakObjectPtr<URt_Place_Trainee_Assign_Popup> Widget_TraineePopup;
