...
UMaterialInterface* FglTFRuntimeParser::BuildMaterial(const int32 Index, const FString& MaterialName, const FglTFRuntimeMaterial& RuntimeMaterial, const FglTFRuntimeMaterialsConfig& MaterialsConfig, const bool bUseVertexColors, UMaterialInterface* ForceBaseMaterial)
{
	...
	if (!ForceBaseMaterial)
	{
		...
		// xrdev mod plugin start mat3 /////////////////////////////////////////////////////////////////////////////////////////
		if (RuntimeMaterial.bAlphaBlendOption)
		{
			if (AlphaBlendMaterialsMap.Contains(RuntimeMaterial.MaterialType))
			{
				BaseMaterial = AlphaBlendMaterialsMap[RuntimeMaterial.MaterialType];
			}
		}
	...
	// xrdev mod plugin start mat4 /////////////////////////////////////////////////////////////////////////////////////////
	if (RuntimeMaterial.bAlphaBlendOption)
	{
		Material->SetTextureParameterValue(FName(TEXT("myParamAlpha")), RuntimeMaterial.AlphaBlendTextureCache);
		Material->SetVectorParameterValue(FName(TEXT("myParamDiffuseColor")), RuntimeMaterial.BaseColorFactor);
	}
	// xrdev mod plugin end /////////////////////////////////////////////////////////////////////////////////////////
