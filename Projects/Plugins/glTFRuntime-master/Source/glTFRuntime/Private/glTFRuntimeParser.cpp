...
//	UMaterialInterface* OpaqueMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/glTFRuntime/M_glTFRuntimeBase"));
	...
	// xrdev mod plugin start mat0
	UMaterialInterface* OpaqueMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/glTFRuntime/M_glTFRuntimeBase_ForXR"));
	if (OpaqueMaterial)
	{
	...
	// xrdev mod plugin start mat1 /////////////////////////////////////////////////////////////////////////////////////////
	UMaterialInterface* AlphaBlendMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/glTFRuntime/M_Transmission_glTFRuntimeBase_ForXR"));
	if (AlphaBlendMaterial)
	{
		AlphaBlendMaterialsMap.Add(EglTFRuntimeMaterialType::AlphaBlend, AlphaBlendMaterial);
	}
