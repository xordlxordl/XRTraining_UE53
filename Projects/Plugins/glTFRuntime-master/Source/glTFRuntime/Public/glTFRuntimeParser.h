...
struct FglTFRuntimeMaterial
{
	...
	// xrdev mod plugin
	bool bAlphaBlendOption;
	UTexture2D* AlphaBlendTextureCache;
	...
	FglTFRuntimeMaterial()
	{
		...
		// xrdev mod plugin
		bAlphaBlendOption = false;
		AlphaBlendTextureCache = nullptr;
	}
};
...
protected:
	...
	TMap<EglTFRuntimeMaterialType, TObjectPtr<UMaterialInterface>> AlphaBlendMaterialsMap; // xrdev mod plugin
#else
	...
	TMap<EglTFRuntimeMaterialType, UMaterialInterface*> AlphaBlendMaterialsMap; // xrdev mod plugin
#endif
