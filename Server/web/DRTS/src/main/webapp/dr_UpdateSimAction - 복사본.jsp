...
<jsp:setProperty name="droption" property="path"/>
<jsp:setProperty name="droption" property="area"/>
...
<%
	...
	DROption opt = new DROption();
	DRDBWork db1 = new DRDBWork();
	
	opt = db1.GetOption( uid );
			              ...
			              <div class="row input-group-text dr_simulation">
								...
								<div class="form-group col-md-4 text-start">
				              	<div class="input-group-sm input-group-text">
									...
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="path" id="idfullpath" value="1"
										<%
										if( opt.getPath() == 1)
										{
										%>
						...
						<div class="row input-group-text mt-1 dr_simulation">
								...
								<div class="form-group col-md-4 text-start">
				              	<div class="input-group-sm input-group-text">
									...
									<div class="form-check form-check-inline">
										<input class="form-check-input dr-area" type="radio" name="area" id="idcityarea" value="1"
										<%
										if( opt.getArea() == 1 )
										{
										%>
									...
									<div class="form-check form-check-inline">
										<input class="form-check-input dr-area" type="radio" name="area" id="idhigharea" value="2"
										<%
										if( opt.getArea() == 2 )
										{
										%>
									...
									<div class="form-check form-check-inline">
										<input class="form-check-input dr-area" type="radio" name="area" id="idlowarea" value="3"
										<%
										if( opt.getArea() == 3 )
										{
										%>
...
<!--2 row------------------------------------------------------------------------------------------------------------------------------->
							...
							<div class="form-group col-md-8">
								...
								<div class="col-md-10 card">
									<div class="row mt-1 mx-0">
										...
										value="<%=opt.getWindspeed() %>" disabled>
										</div>
										<div class="col-md-3">
								...
								<div class="row input-group-text">
									<div class="col-8">	
		                                   	<div id="circle">
												...
												<div class = "text-secondary fs-3" id="arrow">&#9660;</div>
												<div id="circle1"></div>
												<div id="circle2"></div>
						...
						<div class="row mt-1">
							...
							<div class="col-md-3">
	                        	<button class="btn btn-warning text-white" onclick ="" type="button">Reset</button>
							</div>
