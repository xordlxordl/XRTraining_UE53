...
<head>
	...
	<%
		...
		DRDBWork db1 = new DRDBWork();
		user = db1.GetTraineeData( uid );
                ...
                <div class="form-row text-bg-light mx-auto">
					...
					<form class="text-center" method="post" action="dr_UpdateSimAction.jsp">
						 <div class="row input-group-text">
							...
							<input type="text" class="form-control mx-3" name ="uid" id="userid" value="<%=user.getUid()%>" readonly >
			              	</div>
							<div class="form-group col-md-2">
				                <input type="text" class="form-control mx-3" name ="szname" id="username"  placeholder="성명" required readonly
			              	...
			              	<label class="mx-3">성별:</label>
								...
								<div class="form-check form-check-inline required">
									<input class="form-check-input" type="radio" name="nsex" id="inlineRadioMan"  value="1" required readonly
										<% if( user.getNsex() == 1 )
										{
										%>
										checked
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="nsex" id="inlineRadioWoman" value="2" readonly
									<% if( user.getNsex() == 2 )
										{
										%>
										checked
							...
							<div class="form-group col-md-3">
						    		...
						    		<input type="text" class="form-control" name = "birthdate" placeholder="생년월일" id=""	required readonly
			             	...
			             	<div class="input-group">
			                	...
			                	<input type="number" class="form-control mx-0" id="age" placeholder="나이" readonly
			                	value="<%=user.GetAge()%>"
			                	>
						...
						<div class="row input-group-text mt-1">
							...
							<div class="form-group col-md-6">
								<input type="text" class="form-control" name = "addr" placeholder="" id="addr"	required readonly
			           ...
			           <div class="row input-group-text">
							<div class="form-group col-md-1">
							<label class="mx-3 float-start">테스트:</label>
							</div>
							
							<div class="form-group col-md-4 mx-3 text-start">
							...
							<div class="form-group col-md-2">
				              	<div class="input-group-sm  input-group-text">
									...
									<div class="form-check form-check-inline">
										<input class="form-check-input dr_checkbox" type="checkbox" name="aebs" id="idaebs" value="1">
						  ...
						  <div class="row input-group-text mt-1">
							<div class="form-group col-md-1">
							<label class="mx-3 float-start">지&nbsp; &nbsp;역:</label>
							</div>
			              ...
			              <div class="row input-group-text mt-1">
							<div class="form-group col-md-1">
							<label class="mx-3 float-start">시간대:</label>
							</div>
							
							<div class="form-group col-md-5 mx-3 text-start">
			              	<div class="input-group-sm input-group-text">
			              	

								<div class="form-check form-check-inline">
									<input class="form-check-input dr-area" type="radio" name="timezone" id="idtimeam" value="1" required>
									<label class="form-check-label" for="idtimeam">오전</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input dr-area" type="radio" name="timezone" id="idtimepm" value="2" >
									<label class="form-check-label" for="idtimepm">오후</label>
								</div>

								<div class="form-check form-check-inline">
									<input class="form-check-input dr-area" type="radio" name="timezone" id="idtimeevening" value="3" >
									<label class="form-check-label" for="idtimeevening">초저녁</label>
								</div>
								
								<div class="form-check form-check-inline">
									<input class="form-check-input dr-area" type="radio" name="timezone" id="idtimenight" value="4" >
					 ...
					 <div class="row input-group-text mt-1">
							<div class="form-group col-md-1">
							<label class="mx-3 float-start">기&nbsp; &nbsp;상:</label>
							</div>
							...
							<div class="form-group col-md-5 mx-3 text-start ">
			              	<div class="input-group-sm input-group-text">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input dr-area" type="radio" name="weather" id="idweathersun" value="1" required>
									<label class="form-check-label" for="idweathersun">맑음</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input dr-area" type="radio" name="weather" id="idweatherrain" value="2" >
									<label class="form-check-label" for="idweatherrain">강우</label>
								</div>

								<div class="form-check form-check-inline">
									<input class="form-check-input dr-area" type="radio" name="weather" id="idweathersnow" value="3" >
									<label class="form-check-label" for="idweathersnow">강설</label>
								</div>
								
								<div class="form-check form-check-inline">
									<input class="form-check-input dr-area" type="radio" name="weather" id="idweatherfog" value="4" >
						...
						<div class="row mt-1 input-group-text">
						<div class="col-md-2 ">
							<label class="float-start mx-3 align-middle">기상 세부:</label >
						</div>
                        <div class="col-md-6 card">
                            ...
                            <div class="row mt-1 mx-0">
								...
								<div class="col-md-7">
									<input type="range" min="0" max="100" class="form-range mt-2" id="IDRangeAmount" oninput="IDEditAmouont.value = IDRangeAmount.value">
								</div>
								
								<div class="col-md-3">
									<input type="number" class="form-control form-control-sm text-center mt-1" id="IDEditAmouont"  placeholder="0~100" oninput="IDRangeAmount.value = IDEditAmouont.value">
								</div>
								...
								<div class="col-md-7">
									<input type="range" min="0" max="45" class="form-range mt-2" id="IDRangeWind" oninput="IDEditWind.value = IDRangeWind.value">
								</div>
								
								<div class="col-md-3">
									<input type="number" class="form-control form-control-sm text-center mt-1" id="IDEditWind"  placeholder="0~45" oninput="IDRangeWind.value = IDEditWind.value">
								</div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    	<div id="circle">
											<div class = "text-danger fs-3 text-opacity-50" id="arrow">&#9660;</div>
											<div id="circle3"></div>
											<div id="circle1"></div>
											<div id="circle2"></div>
										</div>
						...
						<div class="row mt-2">
							...
							<div class="col-md-3">
								<button class="btn border-white text-white bg-black btn-outline-light" type="submit">세팅</button>
							</div>
							<div class="col-md-3">
