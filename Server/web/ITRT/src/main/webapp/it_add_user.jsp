  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      <li class="sidebar-brand">
		...
		<li class="nav-item"><a href="#" class="nav-link text-white fs-4 active">등록</a></li>
		<li class="nav-item"><a href="it_deluser_main.jsp" class="nav-link text-white">삭제 된 유저</a></li>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>유저 등록</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="it_AddUserAction.jsp">
								...
								{
							  	%>
							  	<option value=<%=list.get(i).getOid()%> > <%=list.get(i).getName()%></option>
							  	<%
								}
							  	%>
                                ...
                                <div class="mb-3"><input class="form-control" type="text" name="loginid" placeholder="로그인 계정" maxlength="15" required></div>
                                <div class="mb-3"><input class="form-control" type="text" name="pass" placeholder="비밀번호" maxlength="15" required></div>
