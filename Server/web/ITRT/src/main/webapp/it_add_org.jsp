  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <hr>
		...
		<li class="nav-item"><a href="it_delorg_main.jsp" class="nav-link text-white">삭제 된 조직</a></li>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>조직 등록</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="it_AddOrgAction.jsp">
                                ...
                                <div class="mb-3"><input class="form-control" type="text" name="name" placeholder="조직 이름" maxlength="15" required></div>
                                <div class="mb-3"><input class="form-control" type="text" name="memo" placeholder="비고" maxlength="15" required></div>
