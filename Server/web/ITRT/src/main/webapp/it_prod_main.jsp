...
<head>
	...
	<script src="js/it_myTable5.js"></script>
  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <li class="sidebar-brand">
		...
		<li class="nav-item"><a href="#" class="nav-link text-white fs-4 active">제품</a></li>
		<li class="nav-item"><a href="it_add_prod.jsp" class="nav-link text-white">등록</a></li>
		<hr>
      ...
      >수정메뉴</span>
      	<li class="nav-item" id="id_modyfymenu" style="display:none"><a href="#" onclick="GoToProdEdit()" class="btn btn-primary" type="button" >수정</a></li>
      	<li class="nav-item" id="id_delmenu" style="display:none"><a onclick="DelOrg()" class="btn btn-danger" type="button">삭제</a></li>
		...
		<div class="container">
			...
			<table id="id_maintable" class="table table-striped table-bordered table-dark table-hover" style="table-layout:fixed ; border:1px solid #fff">
					...
					<tr>
						...
						<th class="bg-white text-black text-center" >생성 시간</th>
				...
				<tbody id="id_maintbody" style="display:none">
					...
					<tr>
						...
						<td class="text-center"><%= list.get(i).getCreatetime() %></td>
						<td class="text-center"><%= list.get(i).getDesc() %></td>
