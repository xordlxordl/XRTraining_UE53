...
<head>
	...
	<script src="js/it_myTable3.js"></script>
  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <li class="sidebar-brand">
		...
		<li class="nav-item"><a href="#" class="nav-link text-white fs-4 active ">조직</a></li>
		<li class="nav-item"><a class="nav-link text-white" href="it_add_org.jsp">등록</a></li>
		<li class="nav-item"><a class="nav-link text-white" href="it_delorg_main.jsp">삭제 된 조직</a></li>
      ...
      >수정메뉴</span>
      	<li class="nav-item" id="id_modyfymenu" style="display:none"><a href="#" onclick="GoToOrgEdit()" class="btn btn-primary" type="button">수정</a></li>
