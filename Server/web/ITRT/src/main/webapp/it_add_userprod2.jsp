                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                        ...
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" method="post" action="it_AddUserProdAction2.jsp">
                                ...
                                data-bs-placement="top" 
        						data-bs-custom-class="custom-tooltip"
        						data-bs-title="유저 로그인 ID"
                                >
								<select id="userid" class="form-select bg-dark text-white" name="uid">
							  	<option value=<%=user.getUid()%>> 
							  	<%=user.getLoginid()%></option>
								</select>
								</div>
                                ...
                                <div class="floating-label mb-4" id="id_startdate" class="text-decoration-none" 
                                data-bs-toggle="tooltip" 
                                data-bs-placement="top" 
        						data-bs-custom-class="custom-tooltip"
        						data-bs-title="미 입력시 NOW()"
        						>
                                <input class="form-control" type="datetime-local" step=1 name="createat" placeholder="시작 날짜">
