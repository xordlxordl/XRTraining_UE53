...
function GoToUserProdEdit2()
{
	//alert('uid='+ this_row[0][0]);
    location.href = 'it_edit_userprod2.jsp?uid='+ this_row[0][0];
}

function GoToUserProdEdit()
{
	//alert('uid='+ this_row[0][0]);
    location.href = 'it_edit_userprod.jsp?uid='+ this_row[0][0];
}
