...
{
	Swal.fire({
  title: '['+ this_row[0][2]+'] 조직' + ' 데이터를 삭제합니다',
  ...
  {
    location.href = 'it_DeleteProdAction.jsp?uid='+this_row[0][0] +'&username='+ this_row[0][2];
  }
  else
  {
...
function GoToProdEdit()
{
	//alert('uid='+ this_row[0][0]);
    location.href = 'it_edit_prod.jsp?uid='+ this_row[0][0];
}
