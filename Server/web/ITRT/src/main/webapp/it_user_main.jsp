  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <li class="sidebar-brand">
		...
		<hr>
	      <li class="nav-item"><a href="#" class="nav-link text-white fs-4 active">유저</a></li>
		  <li class="nav-item"><a href="it_add_user.jsp" class="nav-link text-white" >등록</a></li>
		  <li class="nav-item"><a href="it_deluser_main.jsp" class="nav-link text-white">삭제된 유저</a></li>
      <hr>
      <span class="fs-3"
      data-bs-toggle="tooltip"
      data-bs-placement="top"
      ...
      >수정메뉴</span>
      	<li class="nav-item" id="id_modyfymenu" style="display:none"><a onclick="GoToUserEdit()" class="btn btn-primary" type="button">수정</a></li>
		<li class="nav-item" id="id_delmenu" style="display:none"><a onclick="DelUser();" class="btn btn-danger" type="button">삭제</a></li>
		<li class="nav-item" id="id_prodmenu" style="display:none"><a onclick="GetUserProd();" class="btn btn-success" type="button">유저 제품 검색</a></li>
		<li class="nav-item" id="id_addprodmenu" style="display:none"><a onclick="AddUserProd();" class="btn btn-secondary" type="button">유저 제품 등록</a></li>
    </ul>
  </div>
  <!-- /사이드바 -->
		...
		<div class="container">
			...
			<table id="id_maintable" class="table table-striped table-bordered table-dark table-hover" style="table-layout:fixed ; border:1px solid #fff">
					...
					<tr>
						...
						<th class="bg-white text-black text-center" >계정</th>
						<th class="bg-white text-black text-center" >소속 조직ID</th>
						<th class="bg-white text-black text-center" >소속 조직 이름</th>
					</tr>
				</thead>
				<tbody id="id_maintbody" style="display:none">
						<%
						ITDBWork db = new ITDBWork();
						ArrayList< ITUser > list = db.GetUserList();
						int i;
					...
					<tr>
						...
						<td class="text-center"><%= list.get(i).getOrgname() %></td>
...
<footer class="mt-auto text-white-50 fixed-bottom">
	...
	<script src="js/it_myTable.js"></script>
