            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>제품 등록</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="it_AddProdAction.jsp">
                                
                                
                                <div class="mb-3"><input class="form-control" type="text" name="name" placeholder="제품 이름" maxlength="15" required></div>
                                <div class="mb-3"><input class="form-control" type="text" name="desc" placeholder="비고" maxlength="15"></div>
...
if( request.getParameter("myresult") != null )
{
	...
	{		
		...
		{
%>
		<script>MessageBox( '<%=request.getParameter("name")%>' + ' 제품 생성 성공');</script>
<%		
		}
