...
<jsp:useBean id="xrm" class="data.CMap" scope="page"/>
<jsp:setProperty name="xrm" property="nid"/>
<jsp:setProperty name="xrm" property="name"/>
...
<body class="h-75 text-center text-bg-dark">
	...
	int result = db.CreateMap( xrm.getNid(), xrm.getName() );
	...
	if( result == 1 )
	{
		...
		script.println("<script>");
		String x;
		x = "location.href = 'add_map.jsp?myresult=1&name=" + xrm.getName() + "'";
		script.println( x );
		script.println("</script>");
	}
	else if( result == 0 )
