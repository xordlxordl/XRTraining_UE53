...
<div id="page-wrapper">
  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
   ...
   <%
      ...
      <li class="sidebar-brand">
        <a href="main1.jsp" class="align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
  ...
  %>
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <li class="sidebar-brand">
        <a href="main2.jsp" class="align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        	<span class="fs-3">인재</span>
        </a>
      </li>
      <hr>
    </ul>
