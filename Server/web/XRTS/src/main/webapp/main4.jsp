...
<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="context-menu">
 ...
 <div class="menu" style="display: none">
  <ul class="menu-options">
   ...
   <li class="menu-option"><a href="#">Reload</a></li>
   <li class="menu-option"><a href="#"onclick="GoToUserView()" class="nav-link text-white">수정</a></li>
   <li class="menu-option">Exit</li>
   <li class="menu-option">FAQ</li>
   <hr />
