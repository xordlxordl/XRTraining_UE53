...
<div id="page-wrapper">
 ...
 <%
      ...
      %>
	    ...
	    <li class="nav-item"><a href="training_main.jsp" class="nav-link text-white fs-4 active">훈련</a></li>
	    <li class="nav-item"><a href="add_training.jsp" class="nav-link text-white">등록</a></li>
	 <%
      	}
	 %>
      <hr>
      ...
      <span class="fs-3">수정메뉴</span>
      	<li class="nav-item" id="id_modyfymenu" style="display:none"><a href="#" onclick="GoToTrainingEdit()" class="nav-link text-white">수정</a></li>
	...
	<section>
		<div class="container">
			...
			<table id="id_maintable" class="table table-striped table-bordered table-dark table-hover" style="table-layout:fixed ; border:1px solid #fff">
				<thead>
					<tr>
						<th class="bg-white text-black">훈련 ID</th>
						<th class="bg-white text-black">훈련 제목</th>
					</tr>
				</thead>
				<tbody id="id_maintbody" style="display:none">
						...
						ArrayList<Training>	list = db.GetTrainingList();
						int i;
