  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      %>
		...
		<li class="nav-item"><a href="add_server.jsp" class="nav-link text-white fs-4 active">등록</a></li>
		<hr>
		...
		<div class="container">
			<div class="row mb-5">
				<div class="col-md-8 col-xl-9 text-center mx-auto">
                    <h1>데디케이트 서버 등록 페이지</h1>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>서버 등록</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="AddServerAction.jsp">
                                <div class="mb-3"><input class="form-control" type="number" inputmode="numeric" name="nid" placeholder="서버 ID" maxlength="15"></div>
                                <div class="mb-3"><input class="form-control" type="number" name="mapid" placeholder="시나리오(맵) ID" maxlength="15"></div>
                                <div class="mb-3"><input class="form-control" type="text" name="name" placeholder="이름" maxlength="15"></div>
                                <div class="mb-3"><input class="form-control" data-inputmask="'alias': 'ip'" inputmode="numeric" id="ipAddress" name="ip" placeholder="서버주소 ( IP )" maxlength="15"/></div>
                                
                                <div class="mb-3"><input class="form-control" type="number" name="port" placeholder="포트번호" maxlength="15"></div>
...
if( request.getParameter("myresult") != null )
{
	...
	{		
		...
		{
%>
		<script>MessageBox( '<%=request.getParameter("name")%>' + ' 서버 생성 성공');</script>
<%		
		}
