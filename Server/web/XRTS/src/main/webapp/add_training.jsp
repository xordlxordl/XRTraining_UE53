  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      %>
	    ...
	    <li class="nav-item"><a href="add_training.jsp" class="nav-link text-white fs-4 active">등록</a></li>
	 <%
      	}
	 %>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>훈련 등록</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="AddTrainingAction.jsp">
                                <div class="mb-3"><input class="form-control" type="text" name="name" placeholder="훈련 제목" maxlength="15"></div>
