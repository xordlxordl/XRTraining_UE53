				...
				<ul class="navbar-nav nav-masthead justify-content-end flex-grow-1">
					...
					<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-dark gap-1 p-2 rounded-3 mx-0 border-0 shadow w-220px">
										...
										<li><a class="dropdown-item d-flex align-items-center gap-2 py-2" href="join.jsp">훈련자 등록</a></li>
								</ul>
					</li>
		...
		<div class="container">
			<div class="row mb-5">
				<div class="col-md-8 col-xl-9 text-center mx-auto">
                    <h1>XR 훈련시스템 관리자 로그인 페이지</h1>
                    <p class="w-lg-100">슈퍼계정, 관리자, 관제자 계정으로 로그인 해 주세요.</p>
                </div>
            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                        ...
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" method="post" action="loginAction.jsp">
                                <div class="mb-3"><input class="form-control" type="text" name="adminid" placeholder="아이디" maxlength="15"></div>
                                <div class="mb-3"><input class="form-control" type="password" name="adminpass" placeholder="비밀번호" maxlength="15"></div>
