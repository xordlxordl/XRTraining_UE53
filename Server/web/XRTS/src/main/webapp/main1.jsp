  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      %>
	    ...
	    <!--  <li class="nav-item"><a href="ground_main.jsp" class="nav-link text-white">훈련장</a></li> -->
	 <%
      	}
	 %>
  ...
  <!-- /사이드바 -->
	...
	<div class="cover-container d-flex w-100 p-3 mx-auto flex-column">
  	...
  	<main class="px-3 m-auto">
    	<h1>시스템 관리 페이지</h1>
    	<br>
    	<p class="lead">각종 훈련 시스템 관리 페이지 입니다</p>
    	<p class="lead">XR기기 등록, 훈련자 매칭</p>
    	<p class="lead">데디케이트 서버 관리</p>
    	<p class="lead">시나리오, 훈련 시스템 등을 관리합니다</p>
