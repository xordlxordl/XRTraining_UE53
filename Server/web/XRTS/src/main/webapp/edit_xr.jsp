            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light ">
                    	<div class="card-header"> <h3>XR기기 내용</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="EditXRAction.jsp">
                            	<div class="mb-3"><input class="form-control text-white bg-black" type="number" name="nid" placeholder="XR기기ID" maxlength="15" readonly value="<%=nid%>"></div>
                            ...
                            <a onclick="DelXR('<%=nid%>');" class="btn btn-outline-danger"  type="button">삭제</a>
                            </div>
                        </div>
                    </div>
                </div>
