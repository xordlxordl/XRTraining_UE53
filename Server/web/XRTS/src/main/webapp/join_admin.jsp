    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <hr>
		<%
      	...
      	{
		%>
		<li class="nav-item"><a href="admin_main.jsp" class="nav-link text-white">어드민</a></li>
		<li class="nav-item"><a class="nav-link text-white fs-4 active" href="join_admin.jsp">등록</a></li>
		<hr>
		<%
      	}
		%>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>어드민 등록</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="JoinAdminAction.jsp">
                                ...
                                <div class="mb-3"><input class="form-control" type="text" name="userid" placeholder="계정" maxlength="15"></div>
...
if( request.getParameter("myresult") != null )
{
	...
	{		
		...
		{
%>
		<script>MessageBox( '<%=request.getParameter("name")%>' + ' 어드민 생성 성공');</script>
<%		
		}
