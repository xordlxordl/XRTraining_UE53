  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      %>
	    ...
	    <li class="nav-item"><a href="training_main.jsp" class="nav-link text-white">훈련</a></li>
	 <%
      	}
	 %>
      <hr>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light ">
                    	<div class="card-header"> <h3>훈련 내용</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="EditTrainingAction.jsp">
                            	<div class="mb-3"><input class="form-control text-white bg-black" type="number" name="nid" placeholder="훈련 ID" maxlength="15" readonly value="<%=nid%>"></div>
                                
                                <div class="form-floating mb-3">
                                	<input class="form-control" id="id_myinput" type="text" name="name" placeholder="훈련 제목" maxlength="15" value="<%=name%>">
                                	 <label for="id_myinput">훈련 제목</label>
                                </div>
                            ...
                            <a onclick="DelTraining('<%=nid%>');" class="btn btn-outline-danger"  type="button">삭제</a>
                            </div>
                        </div>
                    </div>
                </div>
