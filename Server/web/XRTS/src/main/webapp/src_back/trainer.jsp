    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <hr>
		...
		<li class="nav-item"><a href="trainer_main.jsp" class="nav-link text-white fs-4 active">관제자</a></li>
			<li class="nav-item">
				<a class = "nav-link text-white" href="trainer.jsp">목록</a>
			</li>
			<li class="nav-item">
...
<section>
		<div class="container">
			...
			<table class="table table-striped table-bordered table-dark table-hover" style="text-align:center; border:1px solid #dddddd">
				<thead>
					<tr>
