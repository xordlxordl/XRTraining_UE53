    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <hr>
         <%
      	...
      	{
      %>
		<li class="nav-item"><a href="xr_main.jsp" class="nav-link text-white">XR기기</a></li>
		<li class="nav-item"><a href="server_main.jsp" class="nav-link text-white fs-4 active">등록</a></li>
		<hr>
		...
		<div class="container">
			<div class="row mb-5">
				<div class="col-md-8 col-xl-9 text-center mx-auto">
                    <h1>XR 클라이언트 등록 페이지</h1>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>XR 기기 등록</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="AddXRAction.jsp">
                                <div class="mb-3"><input class="form-control" type="text" name="name" placeholder="XR 기기 이름" maxlength="15"></div>
...
if( request.getParameter("myresult") != null )
{
	...
	{		
		...
		{
%>
		<script>MessageBox( '<%=request.getParameter("name")%>' + ' 클라이언트 생성 성공');</script>
<%		
		}
