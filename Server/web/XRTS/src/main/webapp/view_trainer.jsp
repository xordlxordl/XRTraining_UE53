  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      %>
		...
		%>
		<li class="nav-item"><a href="trainer_main.jsp" class="nav-link text-white fs-4 active">관제자</a></li>
			<li class="nav-item">
				<a class="nav-link text-white" href="join_trainer.jsp">등록</a>
			</li>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>관제자 내용</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="UpdateTrainerAction.jsp">
                            	<div class="mb-3"><input class="form-control text-white bg-black" type="number" name="uid" placeholder="UID" maxlength="15" readonly value="<%=uid%>"></div>
                                <div class="mb-3"><input class="form-control" type="text" name="username" placeholder="이름" maxlength="15" value="<%=name%>"></div>
                                <div class="mb-3"><input class="form-control" type="text" name="usernumber" placeholder="번호" maxlength="15" value="<%=number%>"></div>
                                <div class="mb-3"><input class="form-control" type="text" name="userid" placeholder="계정" maxlength="15" value="<%=id%>"></div>
                                <div class="mb-3"><input class="form-control" type="text" name="userpassword" placeholder="비밀번호" maxlength="15"></div>
                                <div class="bd-example">
                                <button class="btn border-white text-white bg-black btn-outline-light" type="submit">수정</button>
                                
                                
                            </form>
                            <a onclick="DelTrainer('<%=uid%>','<%=name%>');" class="btn btn-outline-danger"  type="button">삭제</a>
                            </div>
                            <div class="my-2"></div>
                        </div>
                    </div>
