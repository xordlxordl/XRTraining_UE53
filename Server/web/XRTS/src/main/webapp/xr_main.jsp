  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
     ...
     <%
      	...
      	{
      %>
		<li class="nav-item"><a href="xr_main.jsp" class="nav-link text-white active fs-4">XR기기</a></li>
		<li class="nav-item">
				<a class="nav-link text-white" href="add_xr.jsp">등록</a>
		</li>
		<hr>
	 ...
	 %>
      ...
      <span class="fs-3">수정메뉴</span>
      	<li class="nav-item" id="id_modyfymenu" style="display:none"><a href="#" onclick="GoToXREdit()" class="nav-link text-white">수정</a></li>
	...
	<section>
		<div class="container">
			...
			<table id="id_maintable" class="table table-striped table-bordered table-dark table-hover" style="table-layout:fixed ; border:1px solid #fff">
				<thead>
					<tr>
						<th class="bg-white text-black">기기 ID</th>
						<th class="bg-white text-black">기기 이름</th>
						<th class="bg-white text-black">훈련자 ID</th>
					</tr>
				</thead>
				<tbody id="id_maintbody" style="display:none">
						...
						ArrayList< XRMachine > list = db.GetXRMachine();
						int i;
