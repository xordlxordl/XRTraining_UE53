            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>훈련자 내용</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-3"></div>
                            
                            <form class="text-center" method="post" action="UpdateUserAction.jsp">
                            ...
                            <a onclick="DelUser('<%=uid%>','<%=name%>');" class="btn btn-outline-danger"  type="button">삭제</a>
                            </div>
