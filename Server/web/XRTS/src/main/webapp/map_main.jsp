  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      %>
	    ...
	    <li class="nav-item"><a href="map_main.jsp" class="nav-link text-white fs-4 active">시나리오</a></li>
	    <li class="nav-item"><a href="add_map.jsp" class="nav-link text-white">등록</a></li>
	    <hr>
	 ...
	 %>
      ...
      <span class="fs-3">수정메뉴</span>
      	<li class="nav-item" id="id_modyfymenu" style="display:none"><a href="#" onclick="GoToMapEdit()" class="nav-link text-white">수정</a></li>
			...
			<table id="id_maintable" class="table table-striped table-bordered table-dark table-hover" style="table-layout:fixed ; border:1px solid #fff">
				<thead>
					<tr>
						...
						<th class="bg-white text-black">시나리오 제목</th>
					</tr>
				</thead>
				<tbody id="id_maintbody" style="display:none">
						...
						DBWork db = new DBWork();
											...
											ArrayList<CMap>	list = db.GetMapList();
											int i;
