		...
		<!-- 화면 사이즈가 줄어서 드랍메뉴가 버튼에 숨었을때 버튼을 누르면 오른쪽 사이드 바에 드랍메뉴가  뜨게 처리 하는 부분 -->
			...
			<div class="offcanvas-body">
				<ul class="navbar-nav nav-masthead justify-content-end flex-grow-1">
					...
					%>
						<li class="nav-item">
							<a class="nav-link" href="ar_logoutAction.jsp">관리자 로그아웃</a>
						</li>
  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      ...
      <li class="sidebar-brand">
        <a href="ar_main.jsp" class="align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        	<span class="fs-3">메인</span>
        </a>
      </li>
      ...
      <hr>
		...
		<li class="nav-item"><a href="tr_role_main.jsp" class="nav-link text-white fs-4 active">보직 관리</a></li>
  ...
  <!-- /사이드바 -->
	...
	<div class="cover-container d-flex w-100 p-3 mx-auto flex-column">
  	...
  	<main class="px-3 m-auto">
    	<h1>보직 관리 페이지</h1>
    	<br>
    	<p class="lead">보직 관리 페이지 입니다</p>
    	<p class="lead"></p>
    	<p class="lead"></p>
    	<p class="lead"></p>
    	<p class="lead">왼쪽 메뉴를 선택하세요</p>
  	</main>
	</div>
