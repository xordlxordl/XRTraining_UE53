...
<header class="navbar navbar-expand-md navbar-dark bg-dark" aria-label="Dark offcanvas navbar">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"> <p class="fs-1"> 훈련자 추가</p> </a>
  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
		...
		if( iAdminGrade < 2 )
        {
      	%>
      	<hr>
		<li class="nav-item"><a href="ar_res_main.jsp" class="nav-link">리소스</a></li>
		<li class="nav-item"><a href="tr_role_main.jsp" class="nav-link text-white">보직 관리</a></li>
		<li class="nav-item"><a href="tr_role_list.jsp" class="nav-link text-white">보직 목록</a></li>
		<li class="nav-item"><a href="tr_role_add.jsp" class="nav-link text-white fs-4 active">보직 추가</a></li>
      	<%
        }
      	%>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>보직 추가</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-1"></div>
                            
                            <form class="text-center" method="post" action="ar_user_add_action.jsp">
                                <div class="mb-3"><input class="form-control" type="number" name="RID" placeholder="보직 번호" required></div>
                                <div class="mb-3"><input class="form-control" type="text" name="RName" placeholder="보직 이름" required></div>
                                
                                <div class="bd-example">
                                <button class="btn border-white text-white bg-black btn-outline-light" type="summit">추가</button>
