...
<header class="navbar navbar-expand-md navbar-dark bg-dark" aria-label="Dark offcanvas navbar">
	<div class="container-fluid">
		<div class="navbar-brand"><div class="fs-1 col-md-2">인원 관리><div class="fs-2 col-md-1 d-inline">훈련자 추가</div></div></div>
...
<div id="page-wrapper">
  ...
  <div id="sidebar-wrapper" class="flex-column flex-shrink-0 p-3 text-bg-dark">
    ...
    <ul class="sidebar-nav nav nav-masthead flex-column mb-auto">
      	...
      	<li class="nav-item"><a href="ar_user_add.jsp" class="nav-link active">훈련자 추가</a></li>
      	<li class="nav-item"><a href="ar_user_list.jsp" class="nav-link ">훈련자 정보 수정</a></li>
      	<li class="nav-item"><a href="ar_user_add_file.jsp" class="nav-link ">CSV 파일 불러오기</a></li>
      	<hr>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div class="card my-5 text-bg-light">
                    	<div class="card-header"> <h3>훈련자 추가</h3></div>
                        <div class="card-body d-flex flex-column align-items-center">
                            <div class="my-1"></div>
                            
                            <form class="text-center" method="post" action="ar_user_add_action.jsp">
                            
								<div class="input-group mb-1">
									<span class="input-group-text col-md-4">훈련자명</span>
									<input class="form-control" type="text" name="username" onkeyup ="checkSpace(this)" onchange ="checkSpace(this)" oninput="checkSpace(this)" maxlength="15" required>
								</div>
							
							
								<div class="input-group mb-1" id="id_numdiv">
									<span class="input-group-text col-md-4">군번</span>
									<input class="form-control" type="text" id="id_usernum" pattern=".{8,10}" name="usernum" minlength ="8" maxlength="10" oninput="CheckArmyNumber(this)" required>
								</div>
								...
								<div class="input-group mb-1">
									...
									<input class="form-control" type="text" name="usergroup" required>
								</div>
								
								<div class="input-group mb-3">
									<span class="input-group-text col-md-4">신장(cm)</span>
									<input class="form-control" type="number" name="height" oninput="checkMaxLength(this)" maxlength="3" required>
								</div>
								<button class="btn btn-light btn-outline-dark col-md-4 btn-sm" onclick="CheckUserNumber()" type="button">등록</button>
                            </form>
