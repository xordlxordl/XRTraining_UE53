			...
			<table id="id_maintable" class="table table-striped table-bordered table-dark table-hover compact" style="table-layout:fixed ; border:1px solid #fff">
				<thead>
					<tr>
						...
						<th class="bg-white col-md-2 text-black">신장(cm)</th>
						<th class="bg-white col-md-2 text-black">수정</th>
					</tr>
				</thead>
				<tbody id="id_maintbody" style="display:none">
						...
						ArrayList<arUser>	list = db.spGetUserList();
						int i;
					...
					<tr>
						...
						<td> <button type="button" class="btn btn-outline-primary col-md-6 btn-ssm text-white" style="cursor: pointer;" onclick="GoToUserEditWithIndex(<%=list.get(i).getUid()%>);">수정하기</button></td>
					</tr>
						<%
						}
						%>
