		...
		<div class="container">
            ...
            <div class="row d-flex justify-content-center">
               	<div class="input-group mb-3">
  					<input type="text" class="form-control" name="searchname" placeholder="훈련자 이름을 입력하세요" value="${param.searchname}" required>
					<input class="input-group-text btn btn-outline-light col-md-2" type="submit" value="검색하기">
            ...
            <thead>
					<tr>
						<th class="bg-white col-md-1 text-black">UID</th>
						<th class="bg-white col-md-2 text-black">훈련자명</th>
						<th class="bg-white col-md-2 text-black">군번</th>
						<th class="bg-white text-black">소속</th>
				...
				<tbody id="id_maintbody" style="display:none">
						...
						ArrayList<arUser>	list = db.spGetUserFindList(keyword);
						int i;
					...
					<tr>
						...
						<td class="text-start ps-4 mt-2"><%= list.get(i).getUsergroup() %></td>
						
						<td> <button type="button" class="btn btn-outline-primary col-md-6 btn-ssm text-white" style="cursor: pointer;" onclick="GoToTrUserLog(<%=list.get(i).getUid()%>);">상세보기</button></td>
					</tr>
						<%
						}
						%>
